...
const page = async ({params}:{params: Promise<{id: string}>}) => {
    ...
    const [post,{selct:editorPosts}] = await Promise.all([
    ...
    //const {selct:editorPosts} = await client.fetch(PLAYLIST_BY_SLUG_QUERY,{slug:'editor-picks'})
                ...
                <div className='flex-between gap-5'>
                    <Link href={`/user/${post.author?._id}`} className='flex gap-2 items-center mb-3'>
                        ...
                        <div>
                            ...
                            <p className='text-16-medium !text-back-300'>
